...
public class ViewPagerHolder extends PagerAdapter {

    private Context context;
    private LayoutInflater layoutInflater;
    private Integer [] images = {R.drawable.banner_a,R.drawable.banner_b};
    ...
    public Object instantiateItem(@NonNull ViewGroup container, int position) {
        ...
        View view = layoutInflater.inflate(R.layout.context_layout,null);
